...
@selector(
    ...
    produces={
        # new columns
        "Jet.hhbtag", "Jet.pt_1", "number_of_jets",
    },
...
def jet_selection(
    ...
    **kwargs,
    ...
    events = set_ak_column(events, "Jet.pt_1", events.Jet.pt - 1)
    events = set_ak_column(events, "number_of_jets", ak.count(events.Jet.pt, axis=1))
